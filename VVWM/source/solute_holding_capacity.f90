...
subroutine solute_holding_capacity(koc)
   ...
   real:: m_sed_1, m_sed_2
   real:: m_bio_1, m_bio_2
   real:: m_doc_1, m_doc_2

   real:: kd_sed_1, kd_sed_2
   real:: kd_bio
   real:: kd_doc_1, kd_doc_2
   
   real :: initial_capacity_1
...
! mass in benthic region
    ...
    !**********************************************************
    !Distributions at initial state
    initial_capacity_1 = kd_sed_1 * m_sed_1 + kd_bio * m_bio_1 + kd_doc_1 * m_doc_1 + vol1
    
    initial_fw1   =              vol1 /initial_capacity_1
    initial_fdoc1 = kd_doc_1 * m_doc_1/initial_capacity_1
    initial_fsed1 = kd_sed_1 * m_sed_1/initial_capacity_1
    initial_fbio1 = kd_bio   * m_bio_1/initial_capacity_1
    
    Cap1_to_Total = initial_capacity_1/(initial_capacity_1+capacity_2)
    ...
    Sediment_conversion_factor = v2/fw2/m_sed_2  !converts pore water (kg/m3) to Total Conc normalized to sed mass (kg/kg)
    
    Wet_sediment_conversion_factor = Sediment_conversion_factor*m_sed_2/(m_sed_2 + v2*1000.)  !density of water = 1000 kg/m3
