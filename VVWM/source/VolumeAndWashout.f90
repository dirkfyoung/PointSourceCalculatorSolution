   ...
   !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    subroutine constant_volume_calc
        ...
        use nonInputVariables, Only: num_records, & 
                                     q_dailyFlow ,           &  !input (m3/sec) array of daily runoff
                                     k_flow,      &  !output array of daily wash out rates (per second)
                                     v,           &  !for this case, v=constant, but keep array to be consistent with program
                                     daily_depth, &
                                     Daily_avg_flow_out
        implicit none
        ...
        if (flow_averaging ==0) then
              q_avg = sum(q_dailyFlow )/num_records 

        else
             call window_average(q_dailyFlow ,flow_averaging,num_records,q_avg) !calculate 30-day previous average  
        endif 
    ...
    subroutine volume_calc
        ...
        implicit none
        integer:: day
        real:: v_0                                !initial water body volume 
        real:: v_max                                !maximum water body volume
        real:: v_min                                !minimum water body volume
        real:: v_previous
        real:: check
        ...
        vol_net = (q_dailyFlow -evap_area+precip_area)*delt  !volume of water added in day; whole array operations
    ...
    daily_depth = v/area !whole array operation (m)
